 ...
 * iterator points to position k1+1. To find the next unvisited
...
public class DepthFirstSearch {
	...
	//starts on  a new component after a component has 
	...
	public Vertex nextUnvisitedAdjacent(Vertex v) {
		...
		//since whenever a vertex is encountered, it is removed 
		//after processing
		while(it.hasNext()) {
			Vertex u = it.next();
